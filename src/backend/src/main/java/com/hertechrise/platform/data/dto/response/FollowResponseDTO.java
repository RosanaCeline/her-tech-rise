...
public record FollowResponseDTO(
        ...
        @Schema(description = "Handle do usuário que está seguindo", example = "@mariaclara")
        ...
        @Schema(description = "Handle do usuário que está sendo seguido", example = "@carlosamaral")
