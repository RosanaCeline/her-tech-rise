...
@Schema(name = "ReceivedApplicationDetailsResponseDTO", description = "Informações detalhadas de uma candidatura do ponto de vista da empresa")
public record ReceivedApplicationDetailsResponseDTO(
